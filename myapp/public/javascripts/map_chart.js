...
/*
function draw_double_map_chart() {
    ...
    let map_url = "/plant_detection/usr/data/results/" + image_set_info["farm_name"] + "/" + 
    image_set_info["field_name"] + "/" + image_set_info["mission_date"] + "/" + job_config["job_uuid"]
